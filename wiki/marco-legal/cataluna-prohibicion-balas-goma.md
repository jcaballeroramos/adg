...
tipo: marco-legal
estado: borrador
ámbito: Catalunya + Estado español
tags: [catalunya, prohibición, balas-goma, balas-foam, regulación, parlament]
---

# Catalunya · Cronología de la prohibición de balas de goma (y el reemplazo por foam)

Catalunya fue **el primer territorio autónomo del Estado español** en prohibir las balas de goma. Esta nota es la cronología completa de cómo se llegó hasta ahí — y de **lo que vino después**: el reemplazo por las balas de foam, que también ciegan y matan.

## Antes de la prohibición

### Internacional
- **2007** — **Kosovo** prohíbe las balas de goma. **Primer territorio europeo** en hacerlo.
...
## El reemplazo: las balas de foam
...
Tras la presión sostenida de [[../autores-y-referencias/organizaciones/iridia|Iridia]], [[../autores-y-referencias/organizaciones/stop-bales-de-goma|Stop Bales de Goma]] y otras, los Mossos modifican el protocolo de uso de las lanzadoras de 40 mm:

- **Distancia mínima** de disparo pasa de **20 a 30 metros**.
- **Prohibido disparar por encima del abdomen** en cualquier caso.
- **Uso restrictivo** a situaciones de peligro para la vida o integridad física.
- **No se pueden usar para dispersar manifestaciones** o aglomeraciones.
...
- **Prohibir las balas de foam** (no solo regular su uso).
- **Trazabilidad real** del agente que dispara cada proyectil.
- **Publicación** completa de los protocolos de uso de **todas** las armas.
- **Mecanismo independiente** de denuncia (no el mismo cuerpo que perpetra los hechos).
