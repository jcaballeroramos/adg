...
tipo: feria
estado: stub
nombre: DSEI — Defense and Security Equipment International
sede: Londres, Reino Unido
periodicidad: bienal
tags: [dsei, londres, reino-unido, condor, spark, expulsión-2019]
---
...
- Reflejó las **diferencias en regulaciones internacionales** sobre el mismo tipo de arma:
  - **Reino Unido / UE**: prohibida por considerarse tortura.
  - **Latinoamérica y otros**: legal y comercializada.
- Este episodio es el **caso simbólico** de cómo las **diferencias de regulación** crean **mercados refugio**: lo que se prohíbe aquí, se exporta y se vende allá.

## Conexiones
- ↔ [[milipol]] — la feria europea continental equivalente.
