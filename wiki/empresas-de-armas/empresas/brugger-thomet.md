...
tags: [brügger-thomet, suiza, lbd40, foam, gl06, daesh, daesh-siria, libia, congo]
---

# Brügger & Thomet (B&T)

Empresa **suiza** fabricante del **LBD40** (lanzador BT-GL06), uno de los lanzadores estándar de **balas de foam** en Europa. **El director ha sido condenado por tráfico de armas**.

## Producto emblemático
- **BT-GL06 / LBD40** — el "lanzador de precisión" estándar de la **Policía Nacional francesa** y, bajo licencia, también de los **Mossos d'Esquadra** (donde dispara las balas de foam).
- Visor holográfico, calibre 40 mm.
